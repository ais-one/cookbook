...
2. may need to add scope
3. npm i --workspace=<a-workspace>
...
npm install vtextpad --workspace=packages2/package-2a
npm install --workspace=packages2/package-2a 

npm install --workspace=@es-labs 
npm install --workspace=js-node
npm install --workspace=js-web
npm install --workspace=react-nestjs

1. ensure proper symlink (package name is important)
2. peer dependency in js-web
