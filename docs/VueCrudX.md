...
Just copy the **common-app/common-webpack/VueCrudX.vue** file into your project and include it as a local or global Vue component
...
You can also refer to the vue-crud-x source code in **common-app/common-webpack/VueCrudX.vue**
